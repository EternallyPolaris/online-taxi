...
import com.polaris.internalcommon.util.JwtInfo;
...
//        parseBody(request);
        ...
        if (StringUtils.isNotBlank(token)){
            JwtInfo tokenJwtInfo = JwtUtils.parseToken(token);
...
//                String redisToken = stringStringBoundValueOperations.get();
                ...
                String redisToken = redisTemplate.opsForValue().get(RedisKeyPrefixConstant.PASSENGER_LOGIN_TOKEN_APP_KEY_PRE + tokenUserId);
